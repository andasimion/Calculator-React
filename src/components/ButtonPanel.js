    ...
    return (
      <div>
        <div>
          ...
          <Button buttonWidth="col-lg-3" label={'9'} type={'numeric'} handleClick={props.handleButtonClick}/>
          <Button buttonWidth="col-lg-3" label={'+'} type={'binaryOperation'} handleClick={props.handleButtonClick}/>
        </div>
        <div>
          <Button buttonWidth="col-lg-3" label={'4'} type={'numeric'} handleClick={props.handleButtonClick}/>
          <Button buttonWidth="col-lg-3" label={'5'} type={'numeric'} handleClick={props.handleButtonClick}/>
          <Button buttonWidth="col-lg-3" label={'6'} type={'numeric'} handleClick={props.handleButtonClick}/>
          <Button buttonWidth="col-lg-3" label={'-'} type={'binaryOperation'} handleClick={props.handleButtonClick}/>
        </div>
        <div>
        ...
        <div>
          <Button buttonWidth="col-lg-3" label={'.'} type={'numeric'} handleClick={props.handleButtonClick}/>
          <Button buttonWidth="col-lg-3" label={'0'} type={'numeric'} handleClick={props.handleButtonClick}/>
          <Button buttonWidth="col-lg-3" label={'%'} type={'unaryOperation'} handleClick={props.handleButtonClick}/>
          <Button buttonWidth="col-lg-3" label={'/'} type={'binaryOperation'} handleClick={props.handleButtonClick}/>
        </div>
        <div>
